...
poemsMatrix = []
#User inputs: # of poems he/she/it wish to analyze and the # of characters to be used for get the rhythm pattern
numberOfPoemsToAnalyse = int(input("How many poems do you wish to analyze: "))
rhythmParameter = int(input("# of characters to be analyzed on the rhythm: "))
...
for i in range(numberOfPoemsToAnalyse):
    ...
    #It show: Cosine similarity, euclidean distance and dot product 
    if len(poemsMatrix)>=2:
        answer = input("\nDo you want to compare two poems?(Y/N)")
        if(answer == "Y" or answer == "y" or answer == "YES"):
            compareA = int( input("# of the first poem: "))
            compareB = int( input("# of the second poem: "))
